...
/**
 * Servlet implementation class RecentSharePackServlet
 */
public class RecentSharePackServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PackListVO packages = sharePackBiz.getAllPackageListOrderByDate(packSearchVO, member);
