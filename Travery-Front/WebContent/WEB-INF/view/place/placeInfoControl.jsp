...
<div id="placeInfoControl_Wrapper">
	...
	<div id="inner_wrapper">
		<div id="allCheckBox"><input type="checkbox" id="massiveSelectCheckBox" /></div>
			...
			<form id="massiveDeleteForm">
				<c:forEach items="${ placeInfo.placeInfoList }" var="placeInfo">						
					<div id="my_previousPlaceList">
						...
						<a href="<c:url value="/hit?placeId=${placeInfo.placeId}" />"> ${ placeInfo.placeName }</a> 
	...
	<div id="right_wrapper">
		...
		<form id="dataForm" name="dataform" enctype="multipart/form-data">
			...
			<div id="placeInfoCreate_imageUpload">
				...
				<img id="blah" class="img-circle"  src="#" style="width:85px; height:85px;"/><br/>
			</div>
