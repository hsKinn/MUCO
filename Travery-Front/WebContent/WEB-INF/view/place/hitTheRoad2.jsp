...
<link rel="stylesheet" type="text/css"
	href="url(http://fonts.googleapis.com/css?family=Roboto+Condensed:400,700)" />
...
<section style="background: #efefe9;">
	<div class="container">
		<div class="row">
			<div class="board">
				<!-- <h2>Welcome to IGHALO!<sup>вт</sup></h2>-->
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="home">
						<h3 class="head text-center">
							Welcome to Bootsnipp<sup>вт</sup> <span style="color: #f48260;">в╛</span>
						</h3>
					...
					<div class="tab-pane fade" id="profile">
						<h3 class="head text-center">
							Create a Bootsnipp<sup>вт</sup> Profile
						</h3>
						<p class="narrow text-center">Lorem ipsum dolor sit amet, his
							ea mollis fabellas principes. Quo mazim facilis tincidunt ut,
							utinam saperet facilisi an vim.</p>
					...
					<div class="tab-pane fade" id="doner">
						...
						<h3 class="head text-center">
							thanks for staying tuned! <span style="color: #f48260;">в╛</span>
							Bootstrap
						</h3>
						<p class="narrow text-center">Lorem ipsum dolor sit amet, his
							ea mollis fabellas principes. Quo mazim facilis tincidunt ut,
