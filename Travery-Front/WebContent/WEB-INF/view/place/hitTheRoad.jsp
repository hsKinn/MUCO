...
<script>
   ...
   jQuery(function() {
	...
	var $ = jQuery;
		...
		$('#focus-koreaJapan').click(function() {
			$('#map1').vectorMap('set', 'focus', {
				regions : [ 'KR', 'JP' ],
				animate : true
			});
		...
		$('#map1').vectorMap(
				{
					...
					onRegionClick : function(event, code) {
						...
						location.href = "/selectedCountry?selectedCountryName="
               ...
               <div id="firstContainer" class="container">
                  ...
                  <div class="tab-content">
                     ...
                     <div id="home" class="tab-pane fade">
                        ...
                        <button id="focus-america" class="countryMapBtn">United States</button>
                        <button id="focus-europe" class="countryMapBtn">Europe</button>
                        <button id="focus-china" class="countryMapBtn">China</button>
                        <button id="focus-koreaJapan" class="countryMapBtn">Korea and Japan</button>
                        <button id="focus-worldMap"  class="countryMapBtn">World Map</button>
                        <button id="removeAllCountries" class="countryMapBtn">Remove All Countries</button>
                     </div>
                     ...
                     <div id="menu3" class="tab-pane fade" style="height: 100%; width: 100%;">
                           ...
                           <c:if test="${ empty placeListByPackId}">
                           		<br/><br/>
                           		<span style="font-size: large;">You didn't select package, or the place doesn't exist in the package</span>
                           </c:if>
                           <script>
