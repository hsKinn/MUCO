...
public class ReportedPlaceBiz {
	...
	public RepoertedPlaceListVO getReportedPlaceList(ReportedPlaceSearchVO reportedPlaceSearchVO) {
		// 1. 전체 게시글의 수
		int allPlaceCount = reportedPlaceDAO.getAllReportedPlaceCount();
		// 1-1. 기본으로 페이지를 만들어준다. 
		...
		//전체 article 받아오기
		List<ReportedPlaceVO> reportedPlaces = reportedPlaceDAO.getAllReportedPlaces(reportedPlaceSearchVO);
