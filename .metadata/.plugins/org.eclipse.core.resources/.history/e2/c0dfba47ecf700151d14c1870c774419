            ...
            <div id="index">
               ...
               <div id="join" style="margin: auto;">
                  <form id="joinForm">
                     ...
                     <input type="text" class="form-control" tabindex="1"
                        id="userEmail" name="userEmail" placeholder="Email"> <input
                        type="password" class="form-control" tabindex="2"
                        id="userPassword" name="userPassword" placeholder="Password">
                     <input type="text" class="form-control" tabindex="1"
                        id="userName" name="userName" placeholder="Nick name"> <br />
                     <label> <a class="btn btn-primary btn-xl page-scroll">Let's
                           Join!</a> <input type="button" id="btnJoin" value="Signup"
                        style="display: none;" />
                     </label>
               ...
               <div id="login" style="margin: auto;">
                  <form id="loginForm">
                     <input type="text" class="form-control" tabindex="1"
                        id="userEmail" name="userEmail" placeholder=" Email"> <input
                        type="password" class="form-control" tabindex="2" id="userPw"
                        name="userPw" placeholder=" Password"> <br /> <label>
                        <a class="btn btn-primary btn-xl page-scroll">Let's fun!</a> <input
                        type="button" id="btnLogin" value="Login" style="display: none;" />
                     </label>
   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-4 col-md-4 text-center">
            <div class="feature">
               <i class="icon-lg glyphicon glyphicon-phone wow fadeInUp"
                  data-wow-delay=".3s"></i>
               <h3>Travery SNS</h3>
         ...
         <div class="col-lg-4 col-md-4 text-center">
            <div class="feature">
               <i class="icon-lg glyphicon glyphicon-calendar wow fadeInUp"
                  data-wow-delay=".3s"></i>
               <h3>Reservation</h3>
               <p class="text-muted">Easy to reserve hotels, air plane, etc... with Travery Reservation Servie!</p>
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="container text-center">
      ...
      <div class="row">
         <div class="col-lg-10 col-lg-offset-1">
            <div class="row">
               <h6 class="wide-space text-center">TRAVERY IS DEVELOPED BY
                  THESE AWESOME GUYS!</h6>
