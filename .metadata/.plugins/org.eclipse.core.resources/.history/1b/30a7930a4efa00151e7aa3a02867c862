...
/**
 * Servlet implementation class PlaceMassiveDeleteServlet
 */
public class PlaceMassiveDeleteServlet extends HttpServlet {
     ...
     */
    public PlaceMassiveDeleteServlet() {
...
//		MemberVO member = (MemberVO) session.getAttribute("_MEMBER_");
		...
		placeBiz.deletePlaces(deletePlaceIds);
