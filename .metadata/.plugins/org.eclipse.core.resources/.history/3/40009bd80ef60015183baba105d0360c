 ...
 */
public class OriginPlaceDetailServlet extends HttpServlet {
     ...
     */
    public OriginPlaceDetailServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("DetailPlace", placeVO);
	    RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/view/place/placeDetail.jsp");
