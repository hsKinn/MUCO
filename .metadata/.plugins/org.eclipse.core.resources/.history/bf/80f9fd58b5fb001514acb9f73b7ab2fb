 ...
 */
public class OverDatedHistoryListServlet extends HttpServlet {
     ...
     */
    public OverDatedHistoryListServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HistoryListVO hisotryListVO = historyBiz.getOverDatedHistoryList(historySearchVO);
