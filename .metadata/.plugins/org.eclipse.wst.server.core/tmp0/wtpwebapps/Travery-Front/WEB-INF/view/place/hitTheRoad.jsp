 	...
 	$(document).ready(function(){
	    ...
	    jQuery(function(){
	      ...
	      $('#focus-multiple').click(function(){
	        $('#map1').vectorMap('set', 'focus', {regions: ['KR', 'JP'], animate: true});
	      });
	      ...
	      $('#map1').vectorMap({
	        ...
	        onRegionClick: function(event, code) {
	        	...
	        	$.post(
	  				...
	  				"<c:url value="/countryCheck" />"
	  				, {"checkCountry" : map.getRegionName(code) }
	  				, function(data){
	  					...
	  					console.log($(".countries").children().text());
	  					if ( jsonData.result ) {
	  						if ( jsonData.countryName == map.getRegionName(code)) {
