...
<script type="text/javascript"
	src="<c:url value="/resource/js/snap.js" />"></script>
<script>
    $(function() {var snapper = new Snap({element: document.getElementById('content')});});
    $(function() {
...
<div class="drawers">
 <div class="left-drawer">content</div>
 </div>
 <div id="content"><a href="#">Menu</a></div>
