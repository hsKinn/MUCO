...
<<<<<<< HEAD:.metadata/.plugins/org.eclipse.wst.server.core/tmp1/work/Catalina/localhost/ROOT/org/apache/jsp/WEB_002dINF/view/place/hitTheRoad_jsp.java
 * Generated at: 2016-03-24 07:34:07 UTC
=======
 * Generated at: 2016-03-28 07:41:46 UTC
>>>>>>> origin/leina_1603251225:.metadata/.plugins/org.eclipse.wst.server.core/tmp0/work/Catalina/localhost/ROOT/org/apache/jsp/WEB_002dINF/view/place/hitTheRoad_jsp.java
...
<<<<<<< HEAD:.metadata/.plugins/org.eclipse.wst.server.core/tmp1/work/Catalina/localhost/ROOT/org/apache/jsp/WEB_002dINF/view/place/hitTheRoad_jsp.java
    _jspx_dependants.put("/WEB-INF/lib/standard.jar", Long.valueOf(1458700069381L));
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\tvar map = $('#map1').vectorMap('get',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t'mapObject');\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t$\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t.post(\r\n");
      ...
      out.write("\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\"selectedCountryName\" : map\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.getRegionName(code)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ map\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.getRegionName(code)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ '\" style=\"text-align: center; font-weight: bold; width: 100px; margin-top: 10px;cursor: pointer; padding: 5px; float:left; margin-left: 10px;\">'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ map\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.getRegionName(code)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ '</div>');\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_c_005furl_005f33(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/view/place/hitTheRoad.jsp(110,13) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f34(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/view/place/hitTheRoad.jsp(150,31) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
