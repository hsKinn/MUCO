...
<!-- jVector Map -->
<script
	src="<c:url value="/resource/js/jvectormap/jquery-jvectormap-2.0.3.min.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/jquery-mousewheel.js" />"></script>

<script
	src="<c:url value="/resource/js/jvectormap/abstract-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/abstract-canvas-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/abstract-shape-element.js" />"></script>

<script src="<c:url value="/resource/js/jvectormap/svg-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/svg-group-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/svg-canvas-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/svg-shape-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/svg-path-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/svg-circle-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/svg-image-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/svg-text-element.js" />"></script>

<script src="<c:url value="/resource/js/jvectormap/vml-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/vml-group-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/vml-canvas-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/vml-shape-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/vml-path-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/vml-circle-element.js" />"></script>
<script
	src="<c:url value="/resource/js/jvectormap/vml-image-element.js" />"></script>
...
<script
	src="<c:url value="/resource/js/jvectormap/jquery-jvectormap-world-mill-en.js" />"></script>
		...
		$('#map1').vectorMap(
				{
					...
					onRegionClick : function(event, code) {
						...
						$.post("<c:url value="/selectedCountry"/>", {
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".axisX").click(function() {
			...
			$.post("<c:url value="/selectedStandard"/>", {
				"selectedStandard" : "X",
				"selectedStandardName" : $(this).text()
			}, function(data) {
				var jsonData = {};
				try {
					jsonData = JSON.parse(data);
					...
					<div id="firstContainer" class="container">
						...
						<ul class="nav nav-pills">
							<li class="active"><a data-toggle="pill" href="#home">나라
									선택</a></li>
							<li id="searchPlaces" class="tapMenu"><a data-toggle="pill"
								href="#menu1">여행지 검색</a></li>
							<li class="tapMenu"><a data-toggle="pill" href="#menu2">나의
									패키지</a></li>
							<li class="tapMenu"><a data-toggle="pill" href="#menu3">경로
									설정</a></li>
						</ul>
						...
						<div class="tab-content">
							...
							<!-- 여행지 검색 탭 -->
							<c:set var="axisX1"
								value="${ sessionScope._MEMBER_.selectedStandardList.get(0) }" />
							<c:set var="axisX2"
								value="${ sessionScope._MEMBER_.selectedStandardList.get(1) }" />
							<c:set var="axisY1"
								value="${ sessionScope._MEMBER_.selectedStandardList.get(2) }" />
							<c:set var="axisY2"
								value="${ sessionScope._MEMBER_.selectedStandardList.get(3) }" />
